  ...
  return (
    <section className="mx-5 max-w-[850px] pt-24">
      ...
      <article className="mb-8">
        <header>
          <h2 className="text-xl font-semibold mb-2">CONDITIONS GÉNÉRALES DE VENTE ---- VUE D’ENSEMBLE</h2>
        </header>
      <p className="mb-4">
        Ce site web est exploité par Indénum. Sur ce site, les termes "nous", "notre" et "nos" font référence à Indénum. Indénum propose ce site web, y compris toutes les informations, tous les outils et tous les services qui y sont disponibles pour vous, l’utilisateur, sous réserve de votre acceptation de l’ensemble des modalités, conditions, politiques et avis énoncés ici.
      </p>
      <p className="mb-4">
      ...
      <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 1 – CONDITIONS D’UTILISATION DE NOTRE BOUTIQUE EN LIGNE</h2>
          </header>
          <p>
            En acceptant ces Conditions Générales de Vente et d’Utilisation, vous déclarez que vous avez atteint l’âge de la majorité dans votre pays, État ou province de résidence, et que vous nous avez donné votre consentement pour permettre à toute personne d’âge mineur à votre charge d’utiliser ce site web. L’utilisation de nos produits à toute fin illégale ou non autorisée est interdite, et vous ne devez pas non plus, dans le cadre de l’utilisation du Service, violer les lois de votre juridiction (incluant mais ne se limitant pas aux lois relatives aux droits d’auteur).
          </p>
          <p>
            Vous ne devez pas transmettre de vers, de virus ou tout autre code de nature destructive. Toute infraction ou violation des présentes Conditions Générales de Vente et d’Utilisation entraînera la résiliation immédiate de vos Services.
          </p>
        </article>

        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 2 – CONDITIONS GÉNÉRALES</h2>
          </header>
          <p>
            Nous nous réservons le droit de refuser à tout moment l’accès aux services à toute personne, et ce, pour quelque raison que ce soit. Vous comprenez que votre contenu (à l’exclusion de vos informations de carte de crédit) pourrait être transféré de manière non chiffrée, et cela sous-entend (a) des transmissions sur divers réseaux ; et (b) des changements pour se conformer et s’adapter aux exigences techniques pour la connexion des réseaux ou appareils. Les informations de carte de crédit sont toujours chiffrées pendant la transmission sur les réseaux.
          </p>
          <p>
        ...
        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 3 – EXACTITUDE, EXHAUSTIVITÉ ET ACTUALITÉ DES INFORMATIONS</h2>
          </header>
          <p>
        ...
        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 4 – MODIFICATIONS APPORTÉES AU SERVICE ET AUX PRIX</h2>
          </header>
          <p>
        ...
        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 5 – PRODUITS OU SERVICES (LE CAS ÉCHÉANT)</h2>
          </header>
          <p>
        ...
        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 6 – EXACTITUDE DE LA FACTURATION ET DES INFORMATIONS DE COMPTE</h2>
          </header>
          <p>
        ...
        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 7 – OUTILS FACULTATIFS</h2>
          </header>
          <p>
            Nous pourrions vous fournir l’accès à des outils de tierces parties sur lesquels nous n’exerçons ni suivi, ni contrôle, ni influence. Vous reconnaissez et acceptez le fait que nous fournissons l’accès à de tels outils "tels quels" et "selon la disponibilité", sans aucune garantie, représentation ou condition d’aucune sorte et sans aucune approbation. Nous n’aurons aucune responsabilité légale résultant de ou liée à l’utilisation de ces outils facultatifs de tiers.
          </p>
        </article>

        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 8 – LIENS DE TIERS</h2>
          </header>
          <p>
            Certains contenus, produits et services disponibles par le biais de notre Service pourraient inclure des éléments provenant de tierces parties. Les liens provenant de tierces parties sur ce site pourraient vous rediriger vers des sites web de tiers qui ne sont pas affiliés à nous.
          </p>
          <p>
        ...
        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 9 – COMMENTAIRES, SUGGESTIONS ET AUTRES PROPOSITIONS D’UTILISATEURS</h2>
          </header>
          <p>
        ...
        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 10 – RENSEIGNEMENTS PERSONNELS</h2>
          </header>
          <p>
        ...
        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 11 – ERREURS, INEXACTITUDES ET OMISSIONS</h2>
          </header>
          <p>
        ...
        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 12 – UTILISATIONS INTERDITES</h2>
          </header>
          <p>
          ...
          <ul className="list-disc pl-5">
            ...
            <li>Pour inciter des tiers à réaliser des actes illégaux ou à y prendre part ;</li>
            <li>Pour enfreindre toute ordonnance régionale ou toute loi, règle ou régulation internationale, fédérale, provinciale ou étatique ;</li>
            <li>Pour porter atteinte à ou violer nos droits de propriété intellectuelle ou ceux de tierces parties ;</li>
            <li>Pour harceler, maltraiter, insulter, blesser, diffamer, calomnier, dénigrer, intimider ou discriminer en fonction du sexe, de l’orientation sexuelle, de la religion, de l’origine ethnique, de la race, de l’âge, de l’origine nationale ou d’un handicap ;</li>
            <li>Pour soumettre des renseignements faux ou trompeurs ;</li>
            <li>Pour téléverser ou transmettre des virus ou tout autre type de code malveillant ;</li>
            <li>Pour recueillir ou suivre les renseignements personnels d’autrui ;</li>
            <li>À des fins obscènes ou immorales ;</li>
            <li>Pour porter atteinte ou contourner les mesures de sécurité de notre Service, de tout autre site web, ou d’Internet.</li>
          </ul>
        </article>

        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 13 – EXCLUSION DE GARANTIES ET LIMITATION DE RESPONSABILITÉ</h2>
          </header>
          <p>
            Nous ne garantissons ni ne prétendons en aucun cas que votre utilisation de notre Service sera ininterrompue, rapide, sécurisée ou sans erreur. Vous acceptez que de temps à autre, nous puissions supprimer le Service pour des périodes de temps indéfinies ou annuler le Service à tout moment, sans vous avertir au préalable.
          </p>
          <p>
        ...
        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 14 – INDEMNISATION</h2>
          </header>
          <p>
            Vous acceptez d’indemniser, de défendre et de protéger Indénum, notre société-mère, nos filiales, sociétés affiliées, partenaires, responsables, directeurs, agents, contractants, concédants, prestataires de services, sous-traitants, fournisseurs, stagiaires et employés, quant à toute réclamation ou demande.
          </p>
        </article>

        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 15 – DISSOCIABILITÉ</h2>
          </header>
          <p>
            Dans le cas où une disposition des présentes Conditions Générales de Vente et d’Utilisation serait jugée comme étant illégale, nulle ou inapplicable, cette disposition pourra néanmoins être appliquée dans la pleine mesure permise par la loi.
          </p>
        </article>

        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 16 – RÉSILIATION</h2>
          </header>
          <p>
            Les obligations et responsabilités engagées par les parties avant la date de résiliation resteront en vigueur après la résiliation de cet accord.
          </p>
        </article>

        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 17 – INTÉGRALITÉ DE L’ACCORD</h2>
          </header>
          <p>
            Ces Conditions Générales de Vente et d’Utilisation constituent l’intégralité de l’entente entre vous et nous.
          </p>
        </article>

        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 18 – LOI APPLICABLE</h2>
          </header>
          <p>
            Ces Conditions Générales de Vente et d’Utilisation seront régies et interprétées en vertu des lois en vigueur.
          </p>
        </article>

        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 19 – MODIFICATIONS APPORTÉES AUX CONDITIONS GÉNÉRALES DE VENTE ET D’UTILISATION</h2>
          </header>
          <p>
            Nous nous réservons le droit, à notre seule discrétion, de mettre à jour, de modifier ou de remplacer toute partie de ces Conditions Générales.
          </p>
        </article>

        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 20 – PHOTOS NON CONTRACTUELLES</h2>
          </header>
          <p>
            Les photos sont non contractuelles et nous ne pourrons donc être tenus pour responsables si certains produits présentent des imperfections.
          </p>
        </article>

        <article className="mb-8">
          <header>
            <h2 className="text-xl font-semibold mb-2">ARTICLE 21 – COORDONNÉES</h2>
          </header>
          <p>
            Les questions concernant les Conditions Générales de Vente et d’Utilisation devraient nous être envoyées à :
            <a href="mailto:indenum@outlook.com" className="text-blue-500 underline"> indenum@outlook.com</a>
          </p>
        </article>
      </section>
    </section>
